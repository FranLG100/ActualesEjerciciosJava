	...
	public void actionPerformed(ActionEvent e) {
		...
		case __INSERTAR:
			...
			try {
				...
				// TODO Auto-generated catch block
				JOptionPane.showMessageDialog(null, "Caracteres Inválidos en ID");
				error=true;
			}
			if(!idValido) {
			...
			try {
				...
				// TODO Auto-generated catch block
				JOptionPane.showMessageDialog(null, "Caracteres Inválidos en Departamento");
				error=true;
			}
			if(!dptoValido) {
			...
			try {
				...
				// TODO Auto-generated catch block
				JOptionPane.showMessageDialog(null, "Caracteres Inválidos en el salario");
				e1.printStackTrace();
				error=true;
			}
			if(!salarioValido) {
